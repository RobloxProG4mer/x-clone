...
/** biome-ignore-all lint/suspicious/noDoubleEquals: n */
/** biome-ignore-all lint/style/useTemplate: n */
/** biome-ignore-all lint/suspicious/noAssignInExpressions: n */
...
var k = (i, t, s) =>
	t in i
		? P(i, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
		: (i[t] = s);
var Y = (i, t, s) => k(i, typeof t != "symbol" ? t + "" : t, s),
	C = (i, t, s) => t.has(i) || z("Cannot " + s);
var e = (i, t, s) => (
		C(i, t, "read from private field"), s ? s.call(i) : t.get(i)
	),
	c = (i, t, s) =>
		t.has(i)
			...
			: t instanceof WeakSet
				...
				: t.set(i, s),
	a = (i, t, s, n) => (
		C(i, t, "write to private field"), n ? n.call(i, s) : t.set(i, s), s
	);
var r, y;
class D {
	constructor(t) {
		...
		Y(this, "onStart", (t) => {
			this.target ||
				(t.target.closest("[data-toast-id]") &&
					(t.preventDefault(),
					(this.target = t.target.closest("[data-toast-id]")),
		...
		Y(this, "onMove", (t) => {
			this.target &&
				((e(this, r) === "inline-start" && t.pageX > this.startX) ||
					(e(this, r) === "inline-end" && t.pageX < this.startX) ||
					(e(this, r) === "block-start" && t.pageY > this.startY) ||
					(e(this, r) === "block-end" && t.pageY < this.startY) ||
		...
		Y(this, "onEnd", (t) => {
			...
			const s = this.currentX - this.startX,
				n = this.currentY - this.startY,
				o = e(this, r).includes("inline")
					? this.targetBCR.width * 0.3
					: this.targetBCR.height * 0.6;
			e(this, r).includes("inline") &&
				Math.abs(s) > o &&
				(this.targetX = s > 0 ? this.targetBCR.width : -this.targetBCR.width),
				e(this, r).includes("block") &&
					Math.abs(n) > o &&
					(this.targetY =
						n > 0 ? this.targetBCR.height : -this.targetBCR.height),
				(this.isDragging = !1);
		});
		Y(this, "update", () => {
			...
			if (
				...
				this.target.style.setProperty("opacity", s),
				this.isDragging)
			)
				return;
			const n =
				Math.abs(e(this, r).includes("inline") ? this.screenX : this.screenY) <
				0.1;
			if (s < 0.01) {
		...
		(this.targetBCR = null),
			...
			(this.targetY = 0),
			(this.isDragging = !1),
			(this.direction = (t == null ? void 0 : t.direction) ?? e(this, r)),
			a(this, y, (t == null ? void 0 : t.removeFunction) ?? e(this, y)),
...
function B(i) {
	"startViewTransition" in document
		? document.startViewTransition(i).ready.catch(() => {})
		: i();
}
var d, w, p, v;
class I {
	...
	resume() {
		e(this, d) ||
			(a(this, w, Date.now()), a(this, d, setTimeout(e(this, p), e(this, v))));
	}
	pause() {
		e(this, d) &&
			(clearTimeout(e(this, d)),
			a(this, d, null),
			a(this, v, e(this, v) - (Date.now() - e(this, w))));
	}
	clear() {
...
class $ {
	...
	constructor(t) {
		...
		a(
			this,
			T,
			(t == null ? void 0 : t.timeout) !== void 0 ? t.timeout : e(this, T),
		),
			a(this, l, (t == null ? void 0 : t.position) || e(this, l)),
			a(this, g, (t == null ? void 0 : t.minimized) || e(this, g)),
			a(this, X, (t == null ? void 0 : t.maxToasts) || e(this, X));
		const s = (t == null ? void 0 : t.root) || document.body,
			n = L.content.cloneNode(!0);
		a(this, u, n.querySelector('[data-toast="popover"]')),
			(e(this, u).dataset.toastPosition = e(this, l)),
			a(this, m, n.querySelector('[data-toast="container"]')),
			s.appendChild(n),
			a(
				this,
				A,
	...
	update() {
		e(this, h).size === 1 && e(this, u).showPopover(),
			e(this, h).size === 0 && e(this, u).hidePopover(),
			e(this, m).setAttribute("aria-label", `${e(this, h).size} notifications`),
			B(() => {
				(e(this, u).dataset.toastPosition = e(this, l)),
					e(this, g)
						? (e(this, u).dataset.minimized = "")
						: delete e(this, u).dataset.minimized,
					x(e(this, m), () => this.render());
			});
	}
	render() {
		return Array.from(e(this, h))
			.slice(Math.max(e(this, h).size - e(this, X), 0))
			.reverse()
			.map((s) => {
				const n = R.content.cloneNode(!0),
					o = s.id,
					f = `aria-label-${o}`,
					b = n.querySelector('[data-toast="root"]'),
					M = n.querySelector('[data-toast="content"]'),
					S = n.querySelector('[data-toast="actions"]');
				return (
					(b.dataset.toastId = o),
					b.setAttribute("tabindex", "0"),
					b.setAttribute("aria-labelledby", f),
					b.style.setProperty("view-transition-name", `toast-${o}`),
					b.style.setProperty(
						"view-transition-class",
						`toast ${N(e(this, l))}`,
					),
					b.style.setProperty("touch-action", "none"),
					s.action &&
						(S.innerHTML = `<button data-toast-button="action">${s.action.label}</button>`),
					(M.innerHTML = `${s.content}`),
					M.setAttribute("id", f),
					b.outerHTML
				);
			})
	...
	delete(t) {
		for (const s of e(this, h)) s.id === t && e(this, h).delete(s);
		this.update();
	}
	/** Clear all toasts. */
	clearAll() {
	...
	pauseAll() {
		for (const t of e(this, h)) t.timer && t.timer.pause();
	}
	/** Resume the timer for all toasts. */
	resumeAll() {
		for (const t of e(this, h)) t.timer && t.timer.resume();
	}
}
(h = new WeakMap()),
	(T = new WeakMap()),
