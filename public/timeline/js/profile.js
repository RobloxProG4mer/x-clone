            ...
            ${
					...
					${
						...
						transparencyReport.login.country !== "T1"
							...
							${transparencyReport.login.city ? `${esc(transparencyReport.login.city)}, ` : ""}${
								countries
									.find((country) =>
										country.startsWith(
								...
								"Unknown"
							}${transparencyReport.login.country ? `<img src="/public/shared/assets/img/flags/${transparencyReport.login.country.toLowerCase()}.svg" class="flag" alt="${transparencyReport.login.country}" width="16" height="16" onerror="this.remove()">` : ""}
